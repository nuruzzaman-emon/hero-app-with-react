    ...
    return (
        <div className='w-10/12 mx-auto flex flex-col justify-between items-center'>
            <div className='flex justify-center flex-col items-center my-16'>
                <h2 className='text-7xl font-semibold'>We Build </h2>
                <h2 className='text-7xl font-semibold my-3'> <span className='text-[#632EE3] font-bold'>Productive</span> Apps
                </h2>
                <p className='font-medium text-center py-5 text-gray-400'>At HERO.IO , we craft innovative apps designed to make everyday life simpler, smarter, and more exciting. <br /> Our goal is to turn your ideas into digital experiences that truly make an impact.</p>
